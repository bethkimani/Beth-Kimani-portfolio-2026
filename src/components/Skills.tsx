...
const skillCategories = [
  ...
  {
    title: 'Tender & Administrative Skills',
    skills: [
      'Tender Documentation & Proposal Preparation',
      ...
      'Schedules of Rates Preparation',
    ...
    <SectionWrapper id="skills" className="bg-slate-950">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto">
          A comprehensive toolkit combining software development, IT support, and
          business documentation expertise.
        </p>
      </div>
